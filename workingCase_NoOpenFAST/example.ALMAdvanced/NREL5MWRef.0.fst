...
---------------------- INPUT FILES ---------------------------------------------
"5MW_Baseline/ElastoDyn.0.dat"       EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"unused"      InflowFile      - Name of file containing inflow wind input parameters (quoted string) //5MW_Baseline/InflowWind_12mps.dat
"5MW_Baseline/AeroDyn15.dat"         AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"5MW_Baseline/ServoDyn.0.dat"        ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
