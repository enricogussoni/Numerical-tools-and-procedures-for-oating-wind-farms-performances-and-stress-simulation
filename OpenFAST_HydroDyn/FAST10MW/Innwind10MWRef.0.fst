...
InnWind (substituting the NREL 5MW in the example case)
---------------------- SIMULATION CONTROL --------------------------------------
True         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
    400.000   TMax            - Total run time (s)
    0.01000   DT              - Recommended module time step (s)
...
---------------------- INPUT FILES ---------------------------------------------
"10MW_Innwind/ElastoDyn.0.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"10MW_Innwind/AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"10MW_Innwind/ServoDyn.0.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
